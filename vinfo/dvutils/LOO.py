...
class LOO(Adpt_Shapley):
    ...
    def run(self,
        ...
        if metric != "deviation":
            ...
            for idx in tqdm(range(self.n_participants), leave=False):
            ...
            for i in tqdm(range(train_num)):
                try:
                    ...
                    beta = linear_solver(new_kernel_matrix_1_ori, new_kernel_matrix_1, new_train_y.reshape(-1,1), self.class_num)
